...
@objc public protocol iTunesPlaylist: iTunesItem {
    ...
    @objc optional func searchFor(_ for_: String!, only: iTunesESrA) -> SBElementArray // search a playlist for tracks matching the search string. Identical to entering search text in the Search field in iTunes.
